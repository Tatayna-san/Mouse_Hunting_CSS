...
let levelselect = 1;
let leveldata = [
  [{ "lineone": ["justify-content: flex-end;"] }],
  [{ "linetwo": ["justify-content: flex-end;"] }],
  [{ "linethree": ["justify-content: space-between; align-items: flex-end;", "align-items: flex-end; justify-content: space-between;"] }],
  [{ "linefour": ["flex-direction: column;justify-content: space-between;", "flex-direction: column-reverse;justify-content: space-between;", "justify-content: space-between;flex-direction: column;", "justify-content: space-between;flex-direction: column-reverse;"] }],
  [{ "linefive": ["flex-direction: column; justify-content: space-between; align-items: flex-end;", "flex-direction: column; align-items: flex-end; justify-content: space-between;", "justify-content: space-between; flex-direction: column; align-items: flex-end;", "justify-content: space-between; align-items: flex-end; flex-direction: column;", "align-items: flex-end; flex-direction: column; justify-content: space-between;", "align-items: flex-end; justify-content: space-between; flex-direction: column;"] }],
  [{ "linesix": ["justify-content: space-between;"] }, { "lineseven": ["order: 3;"] }, { "lineeight": ["order: 2;"] }, { "linenine": ["order: 1;"] }],
  [{ "lineten": ["align-self: center;"] }, { "lineeleven": ["align-self: flex-end;"] }],
  [{ "linetwelve": ["flex-wrap: wrap;"] }],
  [{ "linethirteen": ["flex-flow: column wrap;", "flex-flow: wrap column;"] }],
  [{ "linefourteen": ["flex-wrap: wrap; align-content: flex-end;", "align-content: flex-end; flex-wrap: wrap;"] }],
  [{ "linefiveteen": ["flex-direction: row-reverse; align-content: flex-end;", "align-content: flex-end; flex-direction: row-reverse;"] }],
  [{ "linesixteen": ["universal"] }]];
